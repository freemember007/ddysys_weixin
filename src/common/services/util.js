angular.module('ddysys.services.util', ['ionic'])

//--------- $alert ---------//
  .factory('$system', $system)

  //--------- 拍照 ---------//
  .factory('$imageHelper', $imageHelper)
...
$fileHelper.$inject = ['$rootScope', 'apiUrl', 'PostData', '$system'];


function $fileHelper($rootScope, apiUrl, PostData, $system) {
  return {
...
$imageHelper.$inject = ['$ionicActionSheet'];


function $imageHelper($ionicActionSheet) {
  return {
